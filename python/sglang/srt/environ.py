...
class Envs:
    ...
    SGLANG_ENABLE_DEGENERATE_STOP = EnvBool(False)
    SGLANG_DEGENERATE_STOP_MIN_TOKENS = EnvInt(3072)
    SGLANG_DEGENERATE_STOP_CHECK_INTERVAL = EnvInt(64)
    SGLANG_DEGENERATE_STOP_REPEAT_COUNT = EnvInt(6)
    SGLANG_DEGENERATE_STOP_TAIL_TOKENS = EnvInt(2048)
