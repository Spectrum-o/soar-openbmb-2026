...
# Exp H (2026-05-21): revert chunked-prefill back to RTN-style baseline.
# Hypothesis: v17/v21 acc=0 platform is caused by chunked-prefill-size=65536 +
# mem-fraction-static=0.80 inherited from a BF16-throughput-tuned branch,
# never accuracy-validated on a quantized model. RTN with chunked-prefill-size
# 8192 scored acc=42 platform; same args + v21 weights should not collapse if
# the quant artifact itself is fine.
