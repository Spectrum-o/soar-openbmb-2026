...
| 2026-05-24 | 08:34 | `soar_w4a16_bf16_chunk65k_20260524_083452.tar.gz` (v5j_dtype_bf16_chunk65k) | 📦 ready | — | — | **chunk32k + chunked-prefill 32K → 65K (the 1849-verified W4A16 max).** Mem budget: 5+67+5.6=77.6 ≤ 84 ✓ (6.4 GB headroom, identical to 1849's verified-safe budget). Expected: acc_ori ~82, S1 ~450-500 (incremental gain over 32K), final_score **~30-35**. Submit ONLY after chunk32k confirms acc stays at ~82 on platform. md5 3f7dc6180e6828752c930e5928a62c06. OneDrive staged. |
