...
# v24_bits8 variant: W8A16 instead of W4A16. Sanity-check whether 4-bit is
# inherently too lossy for SALA, or whether the platform=0 problem is
# elsewhere. 8-bit should pass correctness easily (\~99% acc) at the cost
# of 2x memory + perf. Useful as a baseline against W4A16 variants.
